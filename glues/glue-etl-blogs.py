...
s3_path = "s3://s3-spaceflight-news-raw/blogs/blogs_group_20250223_171252.json"
...
).option("dbtable", "fact_blog").option("user", db_properties["user"]).option(
